(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function s(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(e){if(e.ep)return;e.ep=!0;const i=s(e);fetch(e.href,i)}})();class T{constructor(){this.vertices=[],this.indices=[],this.normals=[],this.fiberVertices=[]}getPosition(t,s){const r=Math.sin(t),e=Math.cos(t),i=Math.sin(s);let a=Math.cos(s)*r,l=e,c=i*r;a*=.85,c*=1.1;const p=5,v=.2;let y=Math.exp(-Math.pow(a*p,2)),u=1;u-=y*v*Math.max(0,l+.5);const d=10,x=.03,P=Math.sin(a*d)*Math.cos(l*d)*Math.sin(c*d*.8),f=Math.cos(a*15+l)*.01;return u+=P*x+f,{x:a*u,y:l*u,z:c*u}}generate(t=80,s=50){this.vertices=[],this.indices=[],this.normals=[],this.fiberVertices=[];for(let r=0;r<=s;r++){const e=r/s*Math.PI;for(let i=0;i<=t;i++){const o=i/t*2*Math.PI,a=this.getPosition(e,o),l=.01,c=this.getPosition(e+l,o),p=this.getPosition(e,o+l),v=c.x-a.x,y=c.y-a.y,u=c.z-a.z,d=p.x-a.x,x=p.y-a.y,P=p.z-a.z;let f=y*P-u*x,m=u*d-v*P,g=v*x-y*d;const b=Math.sqrt(f*f+m*m+g*g);b>1e-4?(f/=b,m/=b,g/=b):(f=a.x,m=a.y,g=a.z),this.vertices.push(a.x,a.y,a.z),this.normals.push(f,m,g),this.fiberVertices.push(a.x,a.y,a.z),this.fiberVertices.push(a.x,a.y,a.z)}}for(let r=0;r<s;r++)for(let e=0;e<t;e++){const i=r*(t+1)+e,o=i+t+1;this.indices.push(i,o,i+1),this.indices.push(o,o+1,i+1)}}getVertexData(){return new Float32Array(this.vertices)}getNormalData(){return new Float32Array(this.normals)}getIndexData(){return new Uint32Array(this.indices)}getFiberData(){return new Float32Array(this.fiberVertices)}getVertexCount(){return this.vertices.length/3}getIndexCount(){return this.indices.length}getFiberVertexCount(){return this.fiberVertices.length/3}}const w=`
struct Uniforms {
