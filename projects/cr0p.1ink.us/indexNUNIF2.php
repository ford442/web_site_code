...
<link rel="stylesheet" charset="utf-8" href="https://css.1ink.us/cr0p16.css">
...
<div id="temptime" hidden>17000</div>
...
<div id="dest-box">
<p>NUNIF Output:</p>
<canvas id="dest" style="position:absolute;opacity:1.0;display:none;top:0vh;z-index:999995;height:100vh;width:100vh;border: 1px solid black;background-color:rgba(255,255,255,1.0);"></canvas>
</div>
...
<canvas id="imag2" style="position:absolute;display:block;top:0;z-index:999994;opacity:0.333;height:100vh;width:100vh;background-color:rgba(255,255,255,0.0);"></canvas>
<canvas id="imag3" style="position:absolute;display:block;top:0;z-index:999995;opacity:0.333;height:100vh;width:100vh;background-color:rgba(255,255,255,0.0);"></canvas>
</div>
</div>
...
<input type="file" id="file" name="file" accept="image/*" style="position:absolute;z-index:999998;top:20vh;height:5vh;left:5vh;width:20vh;width:auto;">
<script>
...
scr.src = "https://wasm.noahcohn.com/b3hd/o0-004.1ijs";
scr.onload = function() { console.log("o0-004.1ijs loaded."); };
scr.onerror = function() { console.error("Error loading o0-004.1ijs"); };
                ...
                scr4.onload = function() {
                    ...
                    scr5.onload = function() {
                        ...
                        setTimeout(function() { // Original third 500ms delay
                            ...
                            scr6.src = "https://js.1ink.us/nunif/cr0p_nunif_64.1ijs";
