...
<main id="panel" style="background-color:rgba(255,255,255,0);">
<script>function openshut(){setTimeout(function(){document.getElementById('shut').innerHTML=2;},1300);}</script>
<canvas id="lb" style="background-color:rgba(255,255,255,0);image-rendering:'auto';top: 0;left: 0;bottom: 0;right: 0;width: 100%;overflow: hidden;z-index: 999994;overflow-y:hidden; overflow-x: hidden;height: 100%;"></canvas>
...
<input type="button" id="buttona" style="color: green;position: absolute;display: block;left: 5%;top: 50%;z-index: 999997;"/>
...
<div id="temptime" hidden>7500</div>
<div id="frptr" hidden></div>
<div id="shut" hidden>1</div>
<div id="wrapper">
<div class="px-video-container" id="myvid">
<img src="./dandilions.jpg" style="opacity:0;position:absolute;z-index:999994;top:0;height:100vh;width:100vw;"></img>
<div class="px-video-wrapper" id="wrap" style="position:absolute;z-index:999995;height:100vh;width:100vh;">
<div id="flip">
<div id="cp" style="z-index:999995;background-color:rgba(255,255,255,0);">
<canvas id="imag"></canvas>

</div>
<div id="cpB" style="z-index:999994;background-color:rgba(255,255,255,0);">
</div>
<div id="cpC" style="z-index:999993;background-color:rgba(255,255,255,0);">
</div>
...
scr.src="https://wasm.noahcohn.com/b3hd/cc002.1ijs";
